...
void MasterRenderScene::insert_direct_light(std::shared_ptr<DirectionalLight> directional_light) {
...
bool MasterRenderScene::remove_direct_light(const std::shared_ptr<DirectionalLight>& directional_light) {
